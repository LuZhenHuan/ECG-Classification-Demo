...
N, T ,D ,L, O= 100, 8, 250 ,8 ,2	#batch_size, seq_length , word_dim	,leads
hidden_size = 50
...
class RNN(nn.Module):
    ...
    def forward(self, input):
        ...
        output = F.relu(self.r2h(hidden[T-1]))
...
class CNN(nn.Module):
    def __init__(self, hidden_size, output_size, n_layers=1, dropout_p=0.001, max_length=L):
        ...
        self.conv1 = nn.Conv2d(1,4,(4,5))
        self.conv2 = nn.Conv2d(4,8,(1,5))
        self.conv3 = nn.Conv2d(8,16,(1,4))

        self.fc1 = nn.Linear(1940, self.hidden_size)
        self.out = nn.Linear(self.hidden_size, self.output_size)
...
rnn1 = RNN(250, 250, 200, 100)
rnn2 = RNN(250, 250, 200, 100)
rnn3 = RNN(250, 250, 200, 100)
rnn4 = RNN(250, 250, 200, 100)
rnn5 = RNN(250, 250, 200, 100)
rnn6 = RNN(250, 250, 200, 100)
rnn7 = RNN(250, 250, 200, 100)
rnn8 = RNN(250, 250, 200, 100)
mlp = CNN(1940,1000,2)
