...
function EM:__init(kwargs)

  self.model_type = utils.get_kwarg(kwargs, 'model_type')
  self.input_dim = utils.get_kwarg(kwargs, 'input_size')
...
function EM:decode_string(encoded)
